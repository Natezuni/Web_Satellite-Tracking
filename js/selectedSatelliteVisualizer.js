am5.ready(function() {
	var satLatitude = localStorage.getItem('satLatitude');
	var satLongitude = localStorage.getItem('satLongitude');
	var currentLatitude = localStorage.getItem('currentLatitude');
	var currentLongitude = localStorage.getItem('currentLongitude');
	console.log(satLatitude, satLongitude);
	...
	pointSeries.data.setAll([
		{
			...
			lat: currentLatitude,
			name: `Current Location Lat: ${currentLatitude} Long: ${currentLongitude}`
		},
		{
			long: satLongitude,
			lat: satLatitude,
			name: `Satellite Location Lat: ${satLatitude} Long: ${satLongitude}`
		}
	]);
